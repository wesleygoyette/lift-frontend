            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div class="bg-white p-6 rounded-lg shadow">
                <div class="text-2xl font-bold text-green-600">
                  {{ recentEntries.length > 0 ? recentEntries.length == 1 ? `${recentEntries.length} recent entry` : `${recentEntries.length} recent entries` : 'No Recent Activity' }}
                </div>
