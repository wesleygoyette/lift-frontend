...
<template>
    <main class="w-screen h-screen flex flex-col items-center">
        <div class="w-full flex flex-col items-center h-screen">
            <h1 class="permanent-marker-regular text-[98px] flex gap-[12px] mt-[10vh] items-baseline">P<span
                    class="text-[48px] mr-[32px]">ersonal</span>R<span class="text-[48px]">ecord</span></h1>
